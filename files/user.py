...
# for local host and faster frames
...
#for hosting anywhere
@user_bp.route('/user/process_frame', methods=['POST'])
def process_frame_endpoint():
    LRCN_model, yolo_model, object_list, IMAGE_HEIGHT, IMAGE_WIDTH, SEQUENCE_LENGTH, CLASSES_LIST = load_models()
    try:
        data = request.json
        ...
        processed_frame_base64 = process_video_usingLiveCam(image_bytes,LRCN_model, yolo_model, object_list, IMAGE_HEIGHT, IMAGE_WIDTH, SEQUENCE_LENGTH, CLASSES_LIST)
